...
//	 * @param stutes 是否覆盖文件
//	 */
//	public GenEntityAndDao(String type, String tname, String outPath, boolean stutes, boolean makeProto) {
...
//		try {
//			String dbName;
//			if (type.equals("db_sz_main")) {
//				subdivision = "game";
//				con = DBPoolMgr.getStrategyConn();
//				dbName = DBPoolMgr.getStrategyNetConfig().getName();
//			} else if (type.equals("db_sz_base")) {
//				subdivision = "base";
//				con = DBPoolMgr.getBaseConn();
//				dbName = DBPoolMgr.getBaseNetConfig().getName();
//			} else if (type.equals("db_sz_log")) {
//				subdivision = "log";
//				con = DBPoolMgr.getLogConn();
//				dbName = DBPoolMgr.getLogNetConfig().getName();
//			} else {
//				System.err.println("类型输入有误");
//				return;
//			}
//
//			// 查要生成实体类的表
...
//					String outputPathProto = directory.getAbsolutePath() + "/src/"
//							+ this.packageOutPath.replace(".", "/") + "/bean/proto/message/" 
...
//				String outputPathB = directory.getAbsolutePath() + "/src/"
...
//				String outputPathD = directory.getAbsolutePath() + "/src/"
...
//				String outputPathDI = directory.getAbsolutePath() + "/src/"
...
//		}
//		sb.append("import com.ly.bean.Option;\r\n");
//		sb.append("import com.ly.bean.DataObject;\r\n");
...
//			sb.append("import com.ly.bean.proto."+protoClassName+"."+protoBeanName+";\r\n");
//		}
//		sb.append("\r\n");
//		// 注释部分
//		sb.append("/**\r\n");
...
//		sb.append("import com.ly.bean." + subdivision + "."
//				+ initcap(className) + ";\r\n");
//
//		// 注释部分
//		sb.append("/**\r\n");
...
//		sb.append("import com.ly.dao." + initcap(className) + "Dao;\r\n");
//		sb.append("import java.util.List;\r\n");
//		sb.append("import java.util.Map;\r\n");
//		sb.append("import java.sql.Types;\r\n");
//		sb.append("import com.ly.db.DbParameter;\r\n");
//		sb.append("import java.util.HashMap;\r\n");
//		sb.append("import java.util.ArrayList;\r\n");
//		sb.append("import com.ly.db.pool.DBPoolMgr;\r\n");
//		sb.append("import com.ly.bean.Option;\r\n");
//		sb.append("import com.ly.bean." + subdivision + "."
//				+ initcap(className) + ";\r\n");
//		sb.append("import com.ly.db.BaseDao;\r\n");
//		sb.append("import com.ly.util.LogUtil;\r\n");
//		
//		sb.append("\r\n");
//		// 注释部分
//		sb.append("/**\r\n");
...
//		if (dataBase.equals("db_sz_main")) {
//			sb.append("\t\treturn DBPoolMgr.getStrategyConn();\r\n");
//		} else if (dataBase.equals("db_sz_base")) {
//			sb.append("\t\treturn DBPoolMgr.getBaseConn();\r\n");
//		} else if (dataBase.equals("db_sz_log")) {
//			sb.append("\t\treturn DBPoolMgr.getLogConn();\r\n");
//		}
//
//		sb.append("\t}\r\n");
//	}
...
//		sb.append("\t\t\t\tLogUtil.error(\"执行出错：\" + sql, e);\r\n");
//		sb.append("\t\t\t} finally {\r\n");
...
//				+ ";\r\n\r\n");
//		sb.append("option java_package = \"com.ly.bean.proto\";\r\n");
